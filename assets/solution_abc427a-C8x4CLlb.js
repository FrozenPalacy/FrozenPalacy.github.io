const t={id:"17",title:"ABC427 - C 题解",slug:"solution_abc427a",date:"Oct 12, 2025",preview:"Problem: C - Bipartize 题目大意 给定一个有$N$个节点和$M$条边的简单图，删去一定边数，使得这个图变成一个二分图。问最少删去多少条边？...",readTime:"1 min read",tags:["OI","Solution"],content:`
