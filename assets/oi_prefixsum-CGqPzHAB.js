const t={id:"21",title:"前缀和 差分 尺取法",slug:"oi_prefixsum",date:"Jul 07, 2023",preview:"前缀和 Def. 某数组前若干数的和 设一数组$a$，$s[1]=a[1]$，$s[2]=a[1]+a[2]$...",readTime:"1 min read",tags:["OI"],content:`
