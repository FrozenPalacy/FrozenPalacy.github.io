const t={id:"22",title:"时间复杂度",slug:"oi_timecomplexity",date:"Sep 12, 2023",preview:"单循环 eg Code void fun(int n) { int i = 0; while (i * i * i <= n) i++; } 次数 0 1 2 条件（iii） 0 1 2^3 etc. 规律：当执行至第k次时...",readTime:"2 min read",tags:["OI"],content:`
