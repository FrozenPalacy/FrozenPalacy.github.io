const l={id:"6",title:"非形式逻辑",slug:"informal_logic",date:"Dec 01, 2025",preview:"一、概念 Definition 概念：反映思维对象特有属性（或本质属性）的思维形态。 语词 对象 属性 特有属性 偶有属性 概念的逻辑特征 内涵 外延...",readTime:"10 min read",tags:["College","Logic"],content:`
