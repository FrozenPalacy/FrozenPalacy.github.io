const t={id:"23",title:"树状数组",slug:"oi_binaryindexedtree",date:"Dec 10, 2023",preview:"树状数组是一种前缀和的优化方法。首先由$lowbit$函数引出。对于一个十进制数$x$，其$lowbit$值为这个数的二进制表达从低位起第一个1的位置所构成的数。",readTime:"1 min read",tags:["OI"],content:`
