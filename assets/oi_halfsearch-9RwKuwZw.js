const l={id:"19",title:"二分查找和二分答案",slug:"oi_halfsearch",date:"Jul 05, 2023",preview:"二分查找（查找特定值） 定义查找区间的左右端点$l$和$r$，查找区间$[l,r]$. 当$l\\leq r$时，计算中间值$mid=(l+r)/2=l+(r-l)/2$. 若$mid=k$，则找到答案...",readTime:"1 min read",tags:["OI"],content:`
