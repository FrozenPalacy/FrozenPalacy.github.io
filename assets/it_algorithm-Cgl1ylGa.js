const l={id:"24",title:"算法的基本概念",slug:"it_algorithm",date:"Jun 15, 2023",preview:"算法是一系列的计算步骤，用来将输入的数据转化成输出的结果。特征：有穷性、确定性、可行性...",readTime:"1 min read",tags:["IT","High School"],content:`
