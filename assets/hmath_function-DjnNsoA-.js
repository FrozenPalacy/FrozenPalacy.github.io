const $={id:"11",title:"高中数学 函数",slug:"hmath_function",date:"Jan 03, 2025",preview:"基本定义 给定一个数集$A$，假设其中的元素为$x$，对$A$中的元素$x$施加对应法则$f$，记作$f(x)$，得到另一数集$B$...",readTime:"1 min read",tags:["High School","Math"],content:`
...
eq1)$，$D=(0,+infty)$，$f(x)in R$，非奇非偶，过定点$(1,0)$。</li>
            <li>当$a&gt;1$时，在$R$上单调增。$ain(0,1)$时，在$R$上单调减。</li>
          </ol>
          <p class="mb-2">eg:</p>
          <ol class="list-decimal pl-6 mt-2 space-y-2">
            <li>
