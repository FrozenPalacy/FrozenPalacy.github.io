const l={id:"20",title:"基础数论",slug:"oi_basicmath",date:"Jul 11, 2023",preview:"质数判断 让$i$从2枚举到$\\sqrt{N}$，若对每一个$i$$n%i\\neq0$，则是质数。否则是合数...",readTime:"1 min read",tags:["OI"],content:`
